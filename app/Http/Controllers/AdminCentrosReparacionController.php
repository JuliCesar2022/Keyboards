<?php namespace App\Http\Controllers;
	...
	class AdminCentrosReparacionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "centros_reparacion";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Centro De Reparaciones","name"=>"centro_reparaciones"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Centro De Reparaciones','name'=>'centro_reparaciones','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Centro De Reparaciones","name"=>"centro de reparaciones","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Horario Comercial","name"=>"Horario comercial","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
