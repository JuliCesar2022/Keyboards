<?php namespace App\Http\Controllers;
	...
	class AdminEquiposController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Ficha","name"=>"Ficha"];
			$this->col[] = ["label"=>"Descripcion","name"=>"descripcion"];
			$this->col[] = ["label"=>"Client Id","name"=>"client_id","join"=>"users,name"];
			$this->col[] = ["label"=>"Tecnico","name"=>"tecnico_id","join"=>"cms_users,name"];
			...
			$this->form[] = ['label'=>'Ficha','name'=>'Ficha','type'=>'textarea','validation'=>'required|min:10|max:500','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Descripcion','name'=>'descripcion','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Tecnico Id','name'=>'tecnico_id','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'cms_users,name',"value"=> \crocodicstudio\crudbooster\helpers\CRUDBooster::myId()];
			...
			//$this->form[] = ["label"=>"Ficha","name"=>"Ficha","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
	    public function hook_query_index(&$query) {
            ...
            if(\crocodicstudio\crudbooster\helpers\CRUDBooster::myPrivilegeId() == CmsUsers::$TECNICO){
                $query->where("tecnico_id","=",CRUDBooster::myId());
            }
