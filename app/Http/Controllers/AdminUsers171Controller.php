<?php namespace App\Http\Controllers;
	...
	class AdminUsers171Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Ciudad","name"=>"Ciudad","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Pais","name"=>"Pais","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
