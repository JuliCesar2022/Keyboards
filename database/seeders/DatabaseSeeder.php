...
class Modulos extends Seeder {
    public function run() {
        ...
        \App\Console\Commands\SetCurrentCrudboosterState::startCommand( $this->command );
    ...
    public function run()
    {
        ...
        if(DB::table('cms_users')->count() == 0) {
            ...
            $cms_users = DB::table('cms_users')->insert(array(
                ...
                'created_at'        => date('Y-m-d H:i:s'),
                'name'              => 'julio bonifacio',
                'email'             => 'juliobonifacio@keyboards.com',
                'tel'             => '573026736193',
                'password'          => $password,
                'id_cms_privileges' => 1,
                'status'            =>'Active',
                ...
                'created_at'        => date('Y-m-d H:i:s'),
                'name'              => 'andres',
                'email'             => 'andresrodriguez@keyboards.com',
                'tel'             => '573225951276',
                'password'          => $password,
                'id_cms_privileges' => \App\Models\CmsUsers::$TECNICO,
                'status'            =>'Active',
            ));
            $cms_users = DB::table('cms_users')->insert(array(
                'id'                =>DB::table('cms_users')->max('id')+1,
                'created_at'        => date('Y-m-d H:i:s'),
                'name'              => 'jesus',
                'email'             => 'jesusmulford@keyboards.com',
                'tel'             => '573212062671',
                'password'          => $password,
                'id_cms_privileges' => \App\Models\CmsUsers::$TECNICO,
                'status'            =>'Active',
            ...
            $cms_users = DB::table('cms_users')->insert(array(
                ...
                'created_at'        => date('Y-m-d H:i:s'),
                'name'              => 'sebastian',
                'email'             => 'sebastianbarragan@keyboards.com',
                'tel'             => '573233747844',
                'password'          => $password,
                'id_cms_privileges' => \App\Models\CmsUsers::$ASESOR,
                'status'            =>'Active',
            ));
            $cms_users = DB::table('cms_users')->insert(array(
                'id'                =>DB::table('cms_users')->max('id')+1,
                'created_at'        => date('Y-m-d H:i:s'),
                'name'              => 'alejandra',
                'email'             => 'alejareyes@keyboards.com',
                'tel'             => '573212200502',
                'password'          => $password,
                'id_cms_privileges' => \App\Models\CmsUsers::$ASESOR,
                'status'            =>'Active',
